...
def convert2squad_example(entry, is_training=False):
    title = entry["title"]
    examples = []
        ...
        with Pool(cpu_count()) as p:
            ...
            exampls_multi = list(
                tqdm(
                    ...
                    desc="convert squad examples",
                )
            )
            examples = [x for single in exampls_multi for x in single]
        return examples
