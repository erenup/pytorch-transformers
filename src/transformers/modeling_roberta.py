...
class RobertaForQuestionAnsweringHotpot(BertPreTrainedModel):
    config_class = RobertaConfig
    pretrained_model_archive_map = ROBERTA_PRETRAINED_MODEL_ARCHIVE_MAP
    base_model_prefix = "roberta"

    def __init__(self, config):
        super(RobertaForQuestionAnsweringHotpot, self).__init__(config)
        self.num_labels = config.num_labels
    ...
    def forward(
        ...
        for example_index in range(batch_size):
            example_input_embs = sequence_output[example_index, :, :]
            example_sentence_indices = sentence_indices[example_index, :, :]
