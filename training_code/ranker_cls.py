...
from data_cls import hotpot_compute_metrics as compute_metrics
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    eval_outputs_dirs = (args.data_dir, args.data_dir + "-MM") if args.task_name == "mnli" else (args.data_dir,)
